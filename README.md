...
CREATE DATABASE IF NOT EXISTS sleep_team_db;                            -- Create a shared database for the project
USE sleep_team_db;                                                      -- Use the project database

CREATE EXTERNAL TABLE patients_raw (
  user_id        INT,
  night_id       INT,
  age            INT,
  sex            STRING,
